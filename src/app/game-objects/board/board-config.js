...
export const canvasConfig = {
    ...
    shadows: {
        ...
        shape: {
            type: "frontFace",
            getProps: ({ top, offsetShadow, thickness, ...props }) => ({ top: top + thickness + offsetShadow, ...props })
        }
    },
    bottomFaces: {
        zIndex: 20,
        ...
        shape: {
            type: "bottomFace",
            getProps: ({ top, height, ...props }) => ({ top: top + height, ...props })
        },
    ...
    rightFaces: {
        ...
        shape: {
            type: "rightFace",
            getProps: ({ left, width, ...props }) => ({ left: left + width - PlayArea.squareSize, ...props }),
        },
        filter: function (squares) {
    ...
    lowestBottomFace: {
        ...
        shape: {
            type: "bottomFace",
            getProps: ({ top, ...props }) => ({ top: top * 0, ...props })
        },
        filter: function (squares) {
